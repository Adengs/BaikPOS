...
public class SelectedVariantsMejaTambahanAdapter extends RecyclerView.Adapter<SelectedVariantsMejaTambahanAdapter.ViewHolder> {
    private List<GetOrderDetail.DATA.TransactionItems.Variants> dataVariant;
    private Context context;

    public SelectedVariantsMejaTambahanAdapter(Context context) {
