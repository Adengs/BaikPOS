...
public class OrderTambahanAdapter extends RecyclerView.Adapter<OrderTambahanAdapter.ViewHolder> {

    private List<GetOrderDetail.DATA.TransactionItems> dataOrder = new ArrayList<>();
    private Context mContext;

    public OrderTambahanAdapter(Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // TODO: 02/04/20 Set Notenya dari mana?
//        holder.tvCatatan.setText(data.getDetailItem());
...
//        holder.tvNamaMakanan.setText(data.getDetailItem().getItemName());
        ...
        SelectedVariantsTambahanAdapter adapter = new SelectedVariantsTambahanAdapter(mContext);
    ...
    public void setDataOrder(List<GetOrderDetail.DATA.TransactionItems> data) {
        this.dataOrder = data;
